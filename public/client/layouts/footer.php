...
<li>
<a href="#" data-gt-lang="la" class="language-item">
...
<script src="/assets/js/bundle-1.js?ver=3.3.0">
</script>
<script src="/assets/js/scripts-1.js?ver=3.3.0">
</script>
<script src="/assets/js/demo-settings-1.js?ver=3.3.0">
</script>
<script src="/assets/js/charts/gd-campaign.js?ver=3.3.0">
</script>
</body>
</html>