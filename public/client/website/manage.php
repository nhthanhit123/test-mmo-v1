...
<div class="toggle-expand-content" data-content="pageMenu">
    ...
    <em class="d-none d-sm-inline icon ni ni-filter-alt">
    
</em>
<span>Filtered By</span>
<em class="dd-indc icon ni ni-chevron-right">
...
<th class="nk-tb-col nk-tb-col-tools text-end">
    <div class="dropdown">
    <a href="#" class="btn btn-xs btn-trigger btn-icon dropdown-toggle me-n1" data-bs-toggle="dropdown" data-offset="0,5">
...
<label class="custom-control-label" for="pid-01">
    
</label>
</div>
</td>
<td class="nk-tb-col">
    <a href="/demo9/apps-kanban.html" class="project-title">
...
<li>
    ...
    <img src="/demo9/images/avatar/b-sm.jpg" alt="">
</div>
</li>
<li>
...
<td class="nk-tb-col tb-col-md">
    ...
    <div class="progress-bar" data-progress="93.5" style="width: 93.5%;">
...
<label class="custom-control-label" for="pid-02">
...
<td class="nk-tb-col tb-col-lg">
    ...
    <li>
    <div class="user-avatar sm bg-primary">
    <img src="/demo9/images/avatar/c-sm.jpg" alt="">
</div>
</li>
<li>
    <div class="user-avatar sm bg-blue">
...
<td class="nk-tb-col tb-col-md">
    <div class="project-list-progress">
    <div class="progress progress-pill progress-md bg-light">
    <div class="progress-bar" data-progress="23" style="width: 23%;">
...
<label class="custom-control-label" for="pid-03">
...
<td class="nk-tb-col tb-col-lg">
    ...
    <li>
    <div class="user-avatar sm bg-primary">
    <img src="/demo9/images/avatar/a-sm.jpg" alt="">
</div>
</li>
</ul>
</td>
...
<div class="project-list-progress">
<div class="progress progress-pill progress-md bg-light">
<div class="progress-bar" data-progress="52.5" style="width: 52.5%;">
</div>
</div>
...
<label class="custom-control-label" for="pid-04">
</label>
</div>
</td>
<td class="nk-tb-col">
...
<div class="project-list-progress">
<div class="progress progress-pill progress-md bg-light">
<div class="progress-bar" data-progress="65.5" style="width: 65.5%;">
</div>
</div>
...
<label class="custom-control-label" for="pid-05">
</label>
</div>
</td>
<td class="nk-tb-col">
...
<li>
<div class="user-avatar sm bg-primary">
<img src="/demo9/images/avatar/d-sm.jpg" alt="">
</div>
</li>
</ul>
</td>
...
<label class="custom-control-label" for="pid-07">
</label>
</div>
</td>
<td class="nk-tb-col">
...
<label class="custom-control-label" for="pid-08">
</label>
</div>
</td>
<td class="nk-tb-col">
...
<span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="2" style="width: 81px;">
<span class="selection">
<span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-mm6b-container">
<span class="select2-selection__rendered" id="select2-mm6b-container" role="textbox" aria-readonly="true" title="1">1</span>
